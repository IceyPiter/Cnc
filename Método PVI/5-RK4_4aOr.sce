...
printf("\n")
printf("============================================================\n")
printf("   MÉT0DO DE RUNGE-KUTTA 4ª ORDEM - APROXIMAÇÕES NUMÉRICAS\n")
printf("============================================================\n")
printf("            i              x(i)              y(i)\n")
printf("------------------------------------------------------------\n")
for i = 1:(n+1)
...
plotar_resultado_aproximado(x, y, [], "Mét0do de Runge-Kutta 4ª Ordem", "Variável independente", "Solução aproximada y(x)")
*/
